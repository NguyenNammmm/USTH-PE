# T02 - Lựa chọn dữ liệu: combo, radio, check và list
...
1. Mỗi radio dùng một StringVar khác nhau thì điều gì sai?

Đáp án: Không còn nhóm loại trừ nhau

- Không còn nhóm loại trừ nhau: Đúng: mỗi nút có state riêng nên có thể cùng chọn.
- Không đổi gì: Biến chung là cơ chế của nhóm.
- Tất cả tự disabled: State disabled là thuộc tính khác.
