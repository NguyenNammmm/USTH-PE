# X04 - PW7: shell có chuyển hướng và pipeline
...
1. Parent giữ đầu ghi pipe sau khi producer kết thúc có thể gây gì?

Đáp án: Consumer chưa thấy EOF

- Consumer chưa thấy EOF: Đúng: mọi đầu ghi phải đóng mới có EOF.
- Luôn nhanh hơn: Giữ handle thừa có thể làm treo.
- Tự xóa file: Pipe không là thao tác xóa file.
