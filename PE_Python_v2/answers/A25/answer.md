# A25 - Pyglet, shader và cube nhiều màu
...
1. Pyglet có cần Tkinter để chạy event loop không?

Đáp án: Không

- Có: Pyglet đã có Window và app loop.
- Không: Đúng.
- Chỉ cần khi có màu: Màu là dữ liệu render, không quyết định toolkit.
