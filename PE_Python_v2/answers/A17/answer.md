# A17 - Chọn loại biểu đồ và quản lý Figure
...
1. Muốn thấy phân phối điểm, chỉ nối các điểm theo tên sinh viên có phù hợp không?

Đáp án: Không, histogram/box/violin có thể phù hợp hơn

- Luôn phù hợp: Tên sinh viên không tự có ý nghĩa liên tục.
- Không, histogram/box/violin có thể phù hợp hơn: Đúng: chọn theo câu hỏi phân phối.
- Phải dùng 3D: 3D không giải quyết câu hỏi này.
