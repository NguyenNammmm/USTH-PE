# C18 - Báo cáo bơi từ file đến kết quả
...
1. File thiếu nên trả báo cáo rỗng như file có dòng trắng không?

Đáp án: Không, đây là hai tình huống khác nhau

- Có: Trả rỗng sẽ che lỗi đường dẫn.
- Không, đây là hai tình huống khác nhau: Đúng: thiếu file giữ FileNotFoundError; dòng trắng có hợp đồng riêng.
- Luôn tạo file mới: Bài đọc không được tự ghi file.
