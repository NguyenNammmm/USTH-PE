# A24 - OpenGL trong wx: cube và phép biến đổi 3D
...
1. Có thể gọi GL trước khi SetCurrent context phù hợp không?

Đáp án: Không bảo đảm đúng

- Có: GL state gắn với context.
- Không bảo đảm đúng: Đúng: cần context hiện hành trên thread vẽ.
- Chỉ cần import OpenGL: Import không tạo context.
