# A21 - wxPython: cửa sổ và các nhóm control
...
1. Có thể thay ttk.Button bằng wx.Button mà giữ mọi API bố cục Tk không?

Đáp án: Không, phải dùng parent/event/sizer của wx

- Có: Hai toolkit có hợp đồng khác.
- Không, phải dùng parent/event/sizer của wx: Đúng.
- Chỉ đổi import: Import không chuyển API.
