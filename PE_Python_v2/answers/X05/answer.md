# X05 - PW8: lưu pickle có nén trong background
...
1. Sao chép nông có đủ nếu state có list/dict lồng nhau đang thay đổi không?

Đáp án: Không

- Luôn đủ: Các phần bên trong vẫn dùng chung tham chiếu.
- Không: Đúng: cần snapshot nhất quán theo mô hình dữ liệu.
- Chỉ cần daemon: Daemon không bảo vệ dữ liệu.
