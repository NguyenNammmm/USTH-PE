# T13 - Slideshow GIF/JPEG và vòng đời ảnh
...
1. Nếu chỉ giữ tên file mà không giữ PhotoImage thì sao?

Đáp án: Ảnh có thể biến mất khi object bị thu gom

- Ảnh luôn còn: Tên file không giữ object PhotoImage.
- Ảnh có thể biến mất khi object bị thu gom: Đúng.
- Tk tự đọc lại file: Không có tự đọc lại như vậy.
