...
1. Mỗi lần di chuyển lại create_rectangle thay vì move thì sao?

Đáp án: Số hình tăng

- Chỉ có một hình: create tạo item mới.
- Số hình tăng: Đúng: cần giữ ID và cập nhật item đó.
- Canvas tự xóa hình cũ: Không có tự xóa.
