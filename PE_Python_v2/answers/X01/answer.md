# X01 - PW1: quản lý lớp bằng collection và CLI
...
1. Hai sinh viên cùng tên có phải là cùng một người không?

Đáp án: Không, dùng mã để phân biệt

- Có: Tên không là định danh ổn định.
- Không, dùng mã để phân biệt: Đúng.
- Chỉ cần lấy người đầu: Lấy người đầu có thể gán nhầm điểm.
