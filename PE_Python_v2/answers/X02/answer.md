# X02 - PW2-PW4: domain objects, GPA và chia package
...
1. Cần chuyển cả thuật toán GPA vào callback curses không?

Đáp án: Không, giữ trong domain/service

- Có: Sẽ trộn trách nhiệm và khó đổi UI.
- Không, giữ trong domain/service: Đúng.
- Curses tự tính GPA: Curses chỉ hiển thị.
