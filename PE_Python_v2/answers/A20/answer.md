# A20 - Nối CRUD MySQL vào giao diện
...
1. Báo Da luu trước khi commit xong có đúng không?

Đáp án: Không

- Có: Commit vẫn có thể thất bại.
- Không: Đúng: phản hồi phải theo kết quả thực.
- Đúng khi mạng nhanh: Tốc độ không thay đổi tính đúng.
